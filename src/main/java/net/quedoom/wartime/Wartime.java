...
// The value here should match an entry in the META-INF/neoforge.mods.tom
// l file
@Mod(Wartime.MOD_ID)
public class Wartime {
    ...
    public Wartime(IEventBus modEventBus, ModContainer modContainer) {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        if (event.getTabKey() == CreativeModeTabs.COMBAT) {
            event.accept(ModItems.SUPER_MEGA_RAPER_MACE);
        }
    }
    ...
    public void onRegisterCommands(RegisterCommandsEvent event) {
        InitializeWarCommand.register(event.getDispatcher());
    }
